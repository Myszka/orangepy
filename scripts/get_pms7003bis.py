...
if notify.enabled():
	notify.status("Initialising PMS7003bis ...")

def measurepms7003(port='/dev/ttyS2',timeavg=60,timeint=1):
	try:
...
logging.warning("Main loop of PMS7003bis ready, synchronizing to full minutes.")
...
while True:
	try:
		...
		time.sleep(1)
		if errcnt > 10:
			logging.critical("PMS7003bis failed")
			sys.exit(66)
